...
var G__30258 = o;
(G__30258[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__30264 = jsprops;
(G__30264["defaultValue"] = value);

(G__30264["onChange"] = ((function (G__30264,v,value,on_change){
return (function (p1__30263_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__30263_SHARP_);
});})(G__30264,v,value,on_change))
);
...
var vec__30267 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__30267,(0),null);
var id = cljs.core.nth.call(null,vec__30267,(1),null);
var class$ = cljs.core.nth.call(null,vec__30267,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___30271 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___30271 == null)){
} else {
var key_30272 = temp__4661__auto___30271;
(jsprops["key"] = key_30272);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__30273 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__30273["name"] = c);
...
var len__29455__auto___30278 = arguments.length;
var i__29456__auto___30279 = (0);
while(true){
if((i__29456__auto___30279 < len__29455__auto___30278)){
args__29462__auto__.push((arguments[i__29456__auto___30279]));

var G__30280 = (i__29456__auto___30279 + (1));
i__29456__auto___30279 = G__30280;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq30276){
var G__30277 = cljs.core.first.call(null,seq30276);
var seq30276__$1 = cljs.core.next.call(null,seq30276);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__30277,seq30276__$1);
});
...
break;
default:
var G__30283 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__30283;
continue;
...
var n__29231__auto___30285 = a.length;
var i_30286 = (0);
while(true){
if((i_30286 < n__29231__auto___30285)){
(a[i_30286] = reagent.impl.template.as_element.call(null,(a[i_30286])));

var G__30287 = (i_30286 + (1));
i_30286 = G__30287;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__29231__auto___30288 = a.length;
var i_30289 = (0);
while(true){
if((i_30289 < n__29231__auto___30288)){
var val_30290 = (a[i_30289]);
if((cljs.core.vector_QMARK_.call(null,val_30290)) && ((reagent.impl.template.key_from_vec.call(null,val_30290) == null))){
(o["no-key"] = true);
} else {
}

(a[i_30289] = reagent.impl.template.as_element.call(null,val_30290));

var G__30291 = (i_30289 + (1));
i_30289 = G__30291;
continue;
} else {
}
...
var ctx = ({});
var vec__30292 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__30292,(0),null);
var derefed = cljs.core.nth.call(null,vec__30292,(1),null);
...
var G__30295 = (cljs.core.count.call(null,argv) - first_child);
switch (G__30295) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__30295){
...
//# sourceMappingURL=template.js.map?rel=1517206652748
