...
var x__39193__auto__ = (((rng == null))?null:rng);
var m__39194__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__39193__auto__)]);
if(!((m__39194__auto__ == null))){
return m__39194__auto__.call(null,rng);
} else {
var m__39194__auto____$1 = (clojure.test.check.random.rand_long["_"]);
if(!((m__39194__auto____$1 == null))){
return m__39194__auto____$1.call(null,rng);
} else {
...
var x__39193__auto__ = (((rng == null))?null:rng);
var m__39194__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__39193__auto__)]);
if(!((m__39194__auto__ == null))){
return m__39194__auto__.call(null,rng);
} else {
var m__39194__auto____$1 = (clojure.test.check.random.rand_double["_"]);
if(!((m__39194__auto____$1 == null))){
return m__39194__auto____$1.call(null,rng);
} else {
...
var x__39193__auto__ = (((rng == null))?null:rng);
var m__39194__auto__ = (clojure.test.check.random.split[goog.typeOf(x__39193__auto__)]);
if(!((m__39194__auto__ == null))){
return m__39194__auto__.call(null,rng);
} else {
var m__39194__auto____$1 = (clojure.test.check.random.split["_"]);
if(!((m__39194__auto____$1 == null))){
return m__39194__auto____$1.call(null,rng);
} else {
...
var x__39193__auto__ = (((rng == null))?null:rng);
var m__39194__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__39193__auto__)]);
if(!((m__39194__auto__ == null))){
return m__39194__auto__.call(null,rng,n);
} else {
var m__39194__auto____$1 = (clojure.test.check.random.split_n["_"]);
if(!((m__39194__auto____$1 == null))){
return m__39194__auto____$1.call(null,rng,n);
} else {
...
return clojure.test.check.random.longs.bit_xor.call(null,G__47320,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__47320;
}
});
...
var G__47323 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__47324 = cljs.core.conj_BANG_.call(null,ret,new_rng);
state__$1 = G__47323;
ret = G__47324;
continue;
}
...
clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__39131__auto__,writer__39132__auto__,opt__39133__auto__){
return cljs.core._write.call(null,writer__39132__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__38460__auto__ = clojure.test.check.random.longs.__GT_long.call(null,seed);
...
var state = cljs.core.get.call(null,map__47326__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__47328 = clojure.test.check.random.split.call(null,state);
var r1 = cljs.core.nth.call(null,vec__47328,(0),null);
var r2 = cljs.core.nth.call(null,vec__47328,(1),null);
...
//# sourceMappingURL=random.js.map?rel=1517725078113
