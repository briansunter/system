...
var and__36368__auto__ = cljs.core.map_QMARK_.call(null,msg);
if(and__36368__auto__){
var and__36368__auto____$1 = new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg);
if(cljs.core.truth_(and__36368__auto____$1)){
var and__36368__auto____$2 = cljs.core.not_EQ_.call(null,new cljs.core.Keyword(null,"msg-name","msg-name",-353709863).cljs$core$IFn$_invoke$arity$1(msg),new cljs.core.Keyword(null,"ping","ping",-1670114784));
if(and__36368__auto____$2){
return cljs.core.swap_BANG_.call(null,figwheel.client.socket.message_history_atom,cljs.core.conj,msg);
} else {
return and__36368__auto____$2;
}
} else {
return and__36368__auto____$1;
}
} else {
return and__36368__auto__;
}
});
figwheel.client.socket.open = (function figwheel$client$socket$open(p__41561){
var map__41562 = p__41561;
var map__41562__$1 = ((((!((map__41562 == null)))?((((map__41562.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41562.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__41562):map__41562);
var opts = map__41562__$1;
var retry_count = cljs.core.get.call(null,map__41562__$1,new cljs.core.Keyword(null,"retry-count","retry-count",1936122875));
var retried_count = cljs.core.get.call(null,map__41562__$1,new cljs.core.Keyword(null,"retried-count","retried-count",-2127867357));
var websocket_url = cljs.core.get.call(null,map__41562__$1,new cljs.core.Keyword(null,"websocket-url","websocket-url",-490444938));
var build_id = cljs.core.get.call(null,map__41562__$1,new cljs.core.Keyword(null,"build-id","build-id",1642831089));
...
socket.onmessage = ((function (url,socket,WebSocket,temp__4655__auto__,map__41562,map__41562__$1,opts,retry_count,retried_count,websocket_url,build_id){
...
});})(url,socket,WebSocket,temp__4655__auto__,map__41562,map__41562__$1,opts,retry_count,retried_count,websocket_url,build_id))
;

socket.onopen = ((function (url,socket,WebSocket,temp__4655__auto__,map__41562,map__41562__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
socket.onclose = ((function (url,socket,WebSocket,temp__4655__auto__,map__41562,map__41562__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
var retried_count__$1 = (function (){var or__36380__auto__ = retried_count;
if(cljs.core.truth_(or__36380__auto__)){
return or__36380__auto__;
} else {
return (0);
}
})();
...
return setTimeout(((function (retried_count__$1,url,socket,WebSocket,temp__4655__auto__,map__41562,map__41562__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (){
...
});})(retried_count__$1,url,socket,WebSocket,temp__4655__auto__,map__41562,map__41562__$1,opts,retry_count,retried_count,websocket_url,build_id))
,(function (){var x__36737__auto__ = (10000);
var y__36738__auto__ = ((2000) + ((500) * retried_count__$1));
return ((x__36737__auto__ < y__36738__auto__) ? x__36737__auto__ : y__36738__auto__);
})());
} else {
return null;
}
...
socket.onerror = ((function (url,socket,WebSocket,temp__4655__auto__,map__41562,map__41562__$1,opts,retry_count,retried_count,websocket_url,build_id){
return (function (x){
...
//# sourceMappingURL=socket.js.map?rel=1517206863165
