...
return cljs.core.map.call(null,cljs.core.first,cljs.core.take_while.call(null,(function (p1__45430_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__45430_SHARP_),cljs.core.second.call(null,p1__45430_SHARP_));
}),cljs.core.map.call(null,(function (p1__45431_SHARP_,p2__45432_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__45431_SHARP_,p2__45432_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__45433 = cljs.core.first.call(null,path_pieces);
switch (G__45433) {
case "":
...
var G__45435 = cljs.core.first.call(null,path_pieces);
...
var G__45437 = cljs.core.last.call(null,path_pieces);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"cwd","cwd",14056523),G__45437)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,"..",G__45437)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"root","root",-448657453),G__45437)){
return path_pieces;
} else {
...
var curr = first__45440;
var remainder = seq__45439__$1;
var pred__45441 = cljs.core._EQ_;
var expr__45442 = curr;
if(cljs.core.truth_(pred__45441.call(null,null,expr__45442))){
return result;
} else {
if(cljs.core.truth_(pred__45441.call(null,"",expr__45442))){
var G__45444 = result;
var G__45445 = remainder;
result = G__45444;
remaining_path = G__45445;
continue;
} else {
if(cljs.core.truth_(pred__45441.call(null,".",expr__45442))){
var G__45446 = result;
var G__45447 = remainder;
result = G__45446;
remaining_path = G__45447;
continue;
} else {
if(cljs.core.truth_(pred__45441.call(null,"..",expr__45442))){
var G__45448 = pathetic.core.up_dir.call(null,result);
var G__45449 = remainder;
result = G__45448;
remaining_path = G__45449;
continue;
} else {
var G__45450 = cljs.core.conj.call(null,result,curr);
var G__45451 = remainder;
result = G__45450;
remaining_path = G__45451;
continue;
}
}
}
...
var expr__45453 = curr;
if(cljs.core.truth_(pred__45452.call(null,null,expr__45453))){
return suffix;
} else {
if(cljs.core.truth_(pred__45452.call(null,"",expr__45453))){
var G__45455 = suffix;
var G__45456 = cljs.core.rest.call(null,remainder);
suffix = G__45455;
remainder = G__45456;
continue;
} else {
if(cljs.core.truth_(pred__45452.call(null,".",expr__45453))){
var G__45457 = suffix;
var G__45458 = cljs.core.rest.call(null,remainder);
suffix = G__45457;
remainder = G__45458;
continue;
} else {
if(cljs.core.truth_(pred__45452.call(null,"..",expr__45453))){
var G__45459 = cljs.core.conj.call(null,suffix,"..");
var G__45460 = cljs.core.rest.call(null,remainder);
suffix = G__45459;
remainder = G__45460;
continue;
} else {
var G__45461 = cljs.core.conj.call(null,suffix,curr);
var G__45462 = cljs.core.rest.call(null,remainder);
suffix = G__45461;
remainder = G__45462;
continue;
}
...
var vec__45463 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__45463,(0),null);
var path = cljs.core.nth.call(null,vec__45463,(1),null);
var post_path = cljs.core.nth.call(null,vec__45463,(2),null);
...
var vec__45466 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__45466,(0),null);
var path = cljs.core.nth.call(null,vec__45466,(1),null);
var post_path = cljs.core.nth.call(null,vec__45466,(2),null);
...
//# sourceMappingURL=core.js.map?rel=1517294170263
