...
var file = cljs.core.get.call(null,map__46352__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__46352__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__46352__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e46351){var _e = e46351;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___46354 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___46354)){
var seen_errors_46355 = temp__4655__auto___46354;
if(cljs.core.truth_(seen_errors_46355.has(self))){
} else {
seen_errors_46355.add(self);

var temp__4657__auto___46356 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___46356)){
var sense_46357 = temp__4657__auto___46356;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_46357)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1517206668317
