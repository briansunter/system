...
var map__52989 = props;
var map__52989__$1 = ((((!((map__52989 == null)))?((((map__52989.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52989.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__52989):map__52989);
var tags = cljs.core.get.call(null,map__52989__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var matching_tags = cljs.core.get.call(null,map__52989__$1,new cljs.core.Keyword(null,"matching-tags","matching-tags",1822958604));
var on_input_update = cljs.core.get.call(null,map__52989__$1,new cljs.core.Keyword(null,"on-input-update","on-input-update",78746968));
var on_add_chip = cljs.core.get.call(null,map__52989__$1,new cljs.core.Keyword(null,"on-add-chip","on-add-chip",624298192));
var on_delete_chip = cljs.core.get.call(null,map__52989__$1,new cljs.core.Keyword(null,"on-delete-chip","on-delete-chip",-1734671046));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [todomvc.scenes.add_action.add_action_app_bar], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs_react_material_ui.reagent.paper,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"z-depth","z-depth",-334122453),(2),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"padding","padding",1660304693),(10),new cljs.core.Keyword(null,"overflow","overflow",2058931880),"hidden"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs_react_material_ui.reagent.text_field,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"floating-label-text","floating-label-text",740415797),"Action Name",new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword("ui.add-action","action-name","ui.add-action/action-name",1785126035).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,add_action)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (add_action,all_tags){
return (function (p1__52991_SHARP_){
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("ui.add-action","update-name","ui.add-action/update-name",-1933137116),todomvc.scenes.add_action.target_value.call(null,p1__52991_SHARP_)], null));
});})(add_action,all_tags))
...
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("ui.add-action","add-tag","ui.add-action/add-tag",-716225407),cljs.core.keyword.call(null,p1__52993_SHARP_)], null));
});})(add_action,all_tags))
...
return re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("ui.add-action","remove-tag","ui.add-action/remove-tag",404998310),cljs.core.keyword.call(null,p1__52994_SHARP_)], null));
});})(add_action,all_tags))
], null)], null)], null)], null);
});

//# sourceMappingURL=add_action.js.map?rel=1518071921692
