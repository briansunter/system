...
return cljs.core.vec.call(null,cljs.core.map.call(null,(function (p1__34638_SHARP_){
if(cljs.core.coll_QMARK_.call(null,p1__34638_SHARP_)){
return posh.lib.pull_analyze.insert_dbid.call(null,p1__34638_SHARP_);
} else {
return p1__34638_SHARP_;
}
...
var and__28274__auto__ = cljs.core.map_QMARK_.call(null,v);
...
var and__28274__auto__ = cljs.core.vector_QMARK_.call(null,v);
if(and__28274__auto__){
...
var temp__4657__auto__ = cljs.core.get.call(null,schema,attr);
...
var vec__34642 = cljs.core.first.call(null,pull_map);
...
return cljs.core.concat.call(null,(cljs.core.truth_((function (){var and__28274__auto__ = cljs.core.not.call(null,r_QMARK_);
if(and__28274__auto__){
return posh.lib.pull_analyze.cardinality_one_QMARK_.call(null,schema,k__$1);
} else {
return and__28274__auto__;
}
})())?cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [entity_id,k__$1,new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(v)], null)], null),posh.lib.pull_analyze.tx_datoms_for_pull_map.call(null,schema,new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(v),v)):(cljs.core.truth_((function (){var or__28286__auto__ = r_QMARK_;
if(cljs.core.truth_(or__28286__auto__)){
return or__28286__auto__;
} else {
return posh.lib.pull_analyze.cardinality_many_QMARK_.call(null,schema,k__$1);
}
})())?cljs.core.concat.call(null,((cljs.core.not.call(null,r_QMARK_))?cljs.core.mapcat.call(null,((function (vec__34642,k,v,r_QMARK_,k__$1){
return (function (p1__34639_SHARP_){
return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [entity_id,k__$1,new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__34639_SHARP_)], null)],null));
});})(vec__34642,k,v,r_QMARK_,k__$1))
,v):null),cljs.core.mapcat.call(null,((function (vec__34642,k,v,r_QMARK_,k__$1){
return (function (p1__34640_SHARP_){
return posh.lib.pull_analyze.tx_datoms_for_pull_map.call(null,schema,new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__34640_SHARP_),cljs.core.merge.call(null,(cljs.core.truth_(r_QMARK_)?cljs.core.PersistentArrayMap.createAsIfByAssoc([k__$1,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("db","id","db/id",-1388397098),entity_id], null)]):null),p1__34640_SHARP_));
});})(vec__34642,k,v,r_QMARK_,k__$1))
...
return cljs.core.concat.call(null,(cljs.core.truth_(posh.lib.pull_analyze.cardinality_many_QMARK_.call(null,schema,k__$1))?cljs.core.mapcat.call(null,((function (vec__34642,k,v,r_QMARK_,k__$1){
return (function (p1__34641_SHARP_){
return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [entity_id,k__$1,p1__34641_SHARP_], null)],null));
});})(vec__34642,k,v,r_QMARK_,k__$1))
...
var and__28274__auto__ = cljs.core.seq_QMARK_.call(null,x);
if(and__28274__auto__){
...
var entity_keys = cljs.core.remove.call(null,(function (p1__34645_SHARP_){
return (cljs.core.map_QMARK_.call(null,p1__34645_SHARP_)) || (cljs.core._EQ_.call(null,new cljs.core.Keyword("db","id","db/id",-1388397098),p1__34645_SHARP_));
}),pull_pattern);
var val_keys = cljs.core.remove.call(null,((function (entity_keys){
return (function (p1__34646_SHARP_){
var or__28286__auto__ = posh.lib.pull_analyze.reverse_lookup_QMARK_.call(null,p1__34646_SHARP_);
if(cljs.core.truth_(or__28286__auto__)){
return or__28286__auto__;
} else {
return posh.lib.pull_analyze.ref_QMARK_.call(null,schema,p1__34646_SHARP_);
}
});})(entity_keys))
,entity_keys);
...
return cljs.core.concat.call(null,((cljs.core.not.call(null,(function (){var or__28286__auto__ = refs_only_QMARK_;
if(cljs.core.truth_(or__28286__auto__)){
return or__28286__auto__;
} else {
...
var ref_key = cljs.core.nth.call(null,vec__34650,(0),null);
var ref_pull = cljs.core.nth.call(null,vec__34650,(1),null);
...
posh.lib.pull_analyze.pull_analyze = (function posh$lib$pull_analyze$pull_analyze(dcfg,retrieve,p__34653,pull_pattern,ent_id){
...
var db = cljs.core.get.call(null,map__34654__$1,new cljs.core.Keyword(null,"db","db",993250759));
var db_id = cljs.core.get.call(null,map__34654__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
var schema = cljs.core.get.call(null,map__34654__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
if(cljs.core.truth_((function (){var and__28274__auto__ = ent_id;
...
posh.lib.pull_analyze.pull_many_analyze = (function posh$lib$pull_analyze$pull_many_analyze(dcfg,retrieve,p__34659,pull_pattern,ent_ids){
...
var db = cljs.core.get.call(null,map__34660__$1,new cljs.core.Keyword(null,"db","db",993250759));
var schema = cljs.core.get.call(null,map__34660__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var db_id = cljs.core.get.call(null,map__34660__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
if(cljs.core.empty_QMARK_.call(null,retrieve)){
return null;
} else {
var resolved_ent_ids = cljs.core.map.call(null,((function (map__34660,map__34660__$1,db,schema,db_id){
return (function (p1__34656_SHARP_){
return new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg).call(null,db,p1__34656_SHARP_);
});})(map__34660,map__34660__$1,db,schema,db_id))
,ent_ids);
var affected_datoms = cljs.core.map.call(null,((function (resolved_ent_ids,map__34660,map__34660__$1,db,schema,db_id){
...
});})(resolved_ent_ids,map__34660,map__34660__$1,db,schema,db_id))
,resolved_ent_ids);
return cljs.core.merge.call(null,(cljs.core.truth_(cljs.core.some.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"results","results",-1134170113),null], null), null),retrieve))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"results","results",-1134170113),affected_datoms], null):null),(cljs.core.truth_(cljs.core.some.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"datoms-t","datoms-t",1641690868),null,new cljs.core.Keyword(null,"datoms","datoms",-290874434),null], null), null),retrieve))?(function (){var datoms = cljs.core.mapcat.call(null,((function (resolved_ent_ids,affected_datoms,map__34660,map__34660__$1,db,schema,db_id){
return (function (p1__34657_SHARP_){
return posh.lib.pull_analyze.generate_affected_tx_datoms_for_pull.call(null,schema,p1__34657_SHARP_);
});})(resolved_ent_ids,affected_datoms,map__34660,map__34660__$1,db,schema,db_id))
,affected_datoms);
return cljs.core.merge.call(null,(cljs.core.truth_(cljs.core.some.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"datoms","datoms",-290874434),null], null), null),retrieve))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"datoms","datoms",-290874434),cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,datoms])], null):null),(cljs.core.truth_(cljs.core.some.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"datoms-t","datoms-t",1641690868),null], null), null),retrieve))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"datoms-t","datoms-t",1641690868),cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,posh.lib.util.t_for_datoms.call(null,new cljs.core.Keyword(null,"q","q",689001697).cljs$core$IFn$_invoke$arity$1(dcfg),db,datoms)])], null):null));
})():null),(cljs.core.truth_(cljs.core.some.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"patterns","patterns",1164082024),null], null), null),retrieve))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"patterns","patterns",1164082024),cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,(function (){var patterns = cljs.core.map.call(null,((function (resolved_ent_ids,affected_datoms,map__34660,map__34660__$1,db,schema,db_id){
return (function (p1__34658_SHARP_){
return posh.lib.pull_analyze.tx_pattern_for_pull.call(null,schema,posh.lib.pull_analyze.insert_dbid.call(null,posh.lib.pull_analyze.remove_limits.call(null,pull_pattern)),p1__34658_SHARP_,false);
});})(resolved_ent_ids,affected_datoms,map__34660,map__34660__$1,db,schema,db_id))
,affected_datoms);
...
//# sourceMappingURL=pull_analyze.js.map?rel=1517206657945
