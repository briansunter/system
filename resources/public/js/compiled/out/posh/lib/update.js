...
posh.lib.update.update_pull = (function posh$lib$update$update_pull(p__36284,storage_key){
...
var posh_tree = map__36285__$1;
var dcfg = cljs.core.get.call(null,map__36285__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.call(null,map__36285__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__36287 = storage_key;
var _ = cljs.core.nth.call(null,vec__36287,(0),null);
var poshdb = cljs.core.nth.call(null,vec__36287,(1),null);
var pull_pattern = cljs.core.nth.call(null,vec__36287,(2),null);
var eid = cljs.core.nth.call(null,vec__36287,(3),null);
...
posh.lib.update.update_filter_pull = (function posh$lib$update$update_filter_pull(p__36290,storage_key){
...
var posh_tree = map__36291__$1;
var dcfg = cljs.core.get.call(null,map__36291__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.call(null,map__36291__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__36293 = storage_key;
var _ = cljs.core.nth.call(null,vec__36293,(0),null);
var poshdb = cljs.core.nth.call(null,vec__36293,(1),null);
var pull_pattern = cljs.core.nth.call(null,vec__36293,(2),null);
var eid = cljs.core.nth.call(null,vec__36293,(3),null);
...
posh.lib.update.update_q_with_dbvarmap = (function posh$lib$update$update_q_with_dbvarmap(p__36296,storage_key){
var map__36297 = p__36296;
var map__36297__$1 = ((((!((map__36297 == null)))?((((map__36297.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__36297.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__36297):map__36297);
var posh_tree = map__36297__$1;
var dcfg = cljs.core.get.call(null,map__36297__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.call(null,map__36297__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));

var vec__36299 = storage_key;
var _ = cljs.core.nth.call(null,vec__36299,(0),null);
var query = cljs.core.nth.call(null,vec__36299,(1),null);
var args = cljs.core.nth.call(null,vec__36299,(2),null);
...
var poshdbmap = cljs.core.apply.call(null,cljs.core.merge,cljs.core.map.call(null,((function (vec__36299,_,query,args,retrieve__$1,qm,dbvarmap,map__36297,map__36297__$1,posh_tree,dcfg,retrieve){
return (function (p__36302){
var vec__36303 = p__36302;
var db_sym = cljs.core.nth.call(null,vec__36303,(0),null);
var poshdb = cljs.core.nth.call(null,vec__36303,(1),null);
...
});})(vec__36299,_,query,args,retrieve__$1,qm,dbvarmap,map__36297,map__36297__$1,posh_tree,dcfg,retrieve))
,dbvarmap));
var fixed_args = cljs.core.map.call(null,((function (vec__36299,_,query,args,retrieve__$1,qm,dbvarmap,poshdbmap,map__36297,map__36297__$1,posh_tree,dcfg,retrieve){
return (function (p__36306){
var vec__36307 = p__36306;
var sym = cljs.core.nth.call(null,vec__36307,(0),null);
var arg = cljs.core.nth.call(null,vec__36307,(1),null);
var or__28286__auto__ = cljs.core.get.call(null,poshdbmap,sym);
if(cljs.core.truth_(or__28286__auto__)){
return or__28286__auto__;
} else {
return arg;
}
});})(vec__36299,_,query,args,retrieve__$1,qm,dbvarmap,poshdbmap,map__36297,map__36297__$1,posh_tree,dcfg,retrieve))
...
var G__36310 = cljs.core.first.call(null,storage_key);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36310__$1)].join('')));

}
});

//# sourceMappingURL=update.js.map?rel=1517206658882
