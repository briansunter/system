...
var vec__36905_36908 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_36909 = cljs.core.nth.call(null,vec__36905_36908,(0),null);
var only_after_36910 = cljs.core.nth.call(null,vec__36905_36908,(1),null);
var db_changed_QMARK__36911 = (!((only_before_36909 == null))) || (!((only_after_36910 == null)));
if(db_changed_QMARK__36911){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_36909);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_36910);
...
var map__36912 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__36912__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__36912__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__36914 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__36914__$1;
var event = cljs.core.get.call(null,map__36914__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__29455__auto___36917 = arguments.length;
var i__29456__auto___36918 = (0);
while(true){
if((i__29456__auto___36918 < len__29455__auto___36917)){
args__29462__auto__.push((arguments[i__29456__auto___36918]));

var G__36919 = (i__29456__auto___36918 + (1));
i__29456__auto___36918 = G__36919;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq36916){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq36916));
});
...
var args__29462__auto__ = [];
var len__29455__auto___36925 = arguments.length;
var i__29456__auto___36926 = (0);
while(true){
if((i__29456__auto___36926 < len__29455__auto___36925)){
args__29462__auto__.push((arguments[i__29456__auto___36926]));

var G__36927 = (i__29456__auto___36926 + (1));
i__29456__auto___36926 = G__36927;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__36920_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__36921_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__36921_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq36922){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__36923,G__36924,seq36922__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1517206659624
