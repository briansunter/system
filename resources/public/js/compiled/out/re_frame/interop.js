...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__30406 = cljs.core.instance_QMARK_;
var expr__30407 = reactive_val;
if(cljs.core.truth_(pred__30406.call(null,reagent.ratom.RAtom,expr__30407))){
return "ra";
} else {
if(cljs.core.truth_(pred__30406.call(null,reagent.ratom.RCursor,expr__30407))){
return "rc";
} else {
if(cljs.core.truth_(pred__30406.call(null,reagent.ratom.Reaction,expr__30407))){
return "rx";
} else {
if(cljs.core.truth_(pred__30406.call(null,reagent.ratom.Track,expr__30407))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1517206652942
